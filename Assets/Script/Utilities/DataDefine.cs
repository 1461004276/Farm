...
public class ItemDetails //物品详细信息类
{
    ...
    public Sprite itemIcon;//物品栏中图标
    public Sprite itemOnWorldIcon;//世界中图片
    public string itemDescription;//详情信息
    ...
    [Range(0, 1)]
    public float sellPercentage;//物品销售打折的百分比
}
[System.Serializable]
public struct InventoryItem //struct结构体更适合来存放背包数据,因为它会默认为0而不是null,避免背包过多报null，同时也可以减少内存的占用
{
    public int itemID;//资产管理中物品的ID
